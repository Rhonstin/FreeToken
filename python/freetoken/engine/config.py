...
class EngineConfig:
    ...
    def model_config(self) -> ModelConfig:
        # the parser sees no section for a tower this process does not build (for the vision
        # tower that also means 1-D rope)
        ...
        return replace(apply_mtp_override(model_config, self.mtp_depth), quant=quant)
