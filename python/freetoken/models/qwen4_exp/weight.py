...
expert banks instead of the state dict. ``model.visual.*`` is renamed to its state-dict
``visual.`` keys and only yielded when the model built the tower (``include_vision``).
"""
