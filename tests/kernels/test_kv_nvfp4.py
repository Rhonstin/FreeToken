...
# NOTE: upstream PR #408 also carries nvfp4 MLA/DSA reader tests
# (test_latent_scatter_matches_reference_and_preserves_prefix,
# test_sparse_mla_nvfp4_matches_restored_reference); they need the MLA/DSA nvfp4
# paths, which are backlog task 5y2.18 and deliberately not ported here.
